-- Social Feed Database Schema for The New Alkebulan
...
-- TODO: Add friends-only policy when friendship system is implemented
-- CREATE POLICY "Friends can view friends-only posts" ON public.posts
--     FOR SELECT USING (
--         privacy = 'friends' AND 
