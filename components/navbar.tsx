        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-56">
                <DropdownMenuItem asChild>
                  <Link href="/investing/alkebulan" className="flex items-center gap-2">
                    <TrendingUp className="h-4 w-4" />
                    Investing Alkebulan
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/investing/my-investments" className="flex items-center gap-2">
                    <BarChart3 className="h-4 w-4" />
                    My Investments
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/investing/more-projects" className="flex items-center gap-2">
